...
function initSceneWithScale(_scale) {
  ...
  camera = new THREE.PerspectiveCamera( 45, window.threejs_panel.width() / window.threejs_panel.height(), 0.1, 1000 );

  camera.position.set(0, -scale * 1.2, scale * 1.7);
  ...
  if (window.experiment &&
    ...
    if (window.target_found && !window.target_received) {
      ...
      window.targetStatusText.set({
        ...
        fontColor: new THREE.Color(0x4CAF50)
      });
    }
  }
